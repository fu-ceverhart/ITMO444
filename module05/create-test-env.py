...
grandtotal = 0
totalPoints = 11
assessmentName = "-5-create-assessment"
...
f = open('create-env--05-results.txt', 'w', encoding="utf-8")

# Gather sha256 of -name and grandtotal
...
print("You should now see a create-env--05-results.txt file has been generated.")
f.close
print('*' * 79)
